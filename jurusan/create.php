        ...
        <div class="card mt-5">
            ...
            <form action="store.php" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"  name="prodi_kode" maxlength="2" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"  name="prodi_jenjang" required>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Status Prodi</label>
                    <input type="text" class="form-control"  name="prodi_status" required>
                </div>
                <div class="mb-3">
